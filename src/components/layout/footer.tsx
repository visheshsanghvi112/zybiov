  ...
  return (
    <footer className="bg-heading text-white relative overflow-hidden">
      ...
      <div className="absolute inset-0 pointer-events-none">
        ...
        <div className="absolute bottom-0 right-0 w-80 h-80 rounded-full bg-secondary/10 blur-3xl translate-x-1/3 translate-y-1/3" />
                ...
                <li key={link.href}>
                  ...
                  >
                    <ArrowRight className={cn(
                      "w-3 h-3 opacity-0 transition-all duration-200 text-primary",
            ...
            <ul className="space-y-3">
              {[
                ...
                <li key={idx}>
                  ...
                  >
                    <ArrowRight className={cn(
                      "w-3 h-3 opacity-0 transition-all duration-200 text-accent",
                      dir === "rtl" ? "rotate-180 translate-x-2 group-hover:translate-x-0" : "-translate-x-2 group-hover:translate-x-0",
                      "group-hover:opacity-100"
                    )} />
                    {sector.title}
          ...
          <div className="flex gap-3">
            {socialLinks.map((s) => (
              <a
                ...
                aria-label={s.label}
                className="w-9 h-9 rounded-xl bg-white/5 border border-white/10 flex items-center justify-center hover:bg-primary hover:border-transparent transition-all duration-200 hover:scale-105"
              >
